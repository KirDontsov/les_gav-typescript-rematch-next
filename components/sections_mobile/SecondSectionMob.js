				...
				<div className="centerSection">
					...
					<div className="colWrapper">
						<div className="mainCol">
							<p>
								Продается комплекс недвижимости с возможностью дальнейшего развития. Гостиница «Лесная гавань» находится на
								склоне Северо-кавказских гор, в живописном месте – пригород Новороссийска, курортный поселок Широкая Балка. Вас
								окружат своим могуществом горы, дубовые, сосновые, можжевеловые леса и потрясающий пляж с кристальной,
								прозрачной водой.
							</p>
							...
							<p>
								Помимо пяти (5) действующих зданий на территории располагаются 16 домиков в горной части участка и здание
								крытого бассейна, требующие реконструкции.
							</p>
						</div>
						<div className="mainCol">
							<div className="box">
